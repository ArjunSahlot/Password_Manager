...
print("Installing...")
try:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/password_manager/archive/main.zip", tmp)
    file += "main"
except urllib.error.HTTPError:
    urllib.request.urlretrieve("https://github.com/ArjunSahlot/password_manager/archive/master.zip", tmp)
    file += "master"
